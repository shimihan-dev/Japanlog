  ...
  return (
    <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-4 flex flex-col h-full">
      ...
      <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-3">
        <div className="flex items-center space-x-1 p-1 bg-slate-100/80 rounded-xl">
          <button
        ...
        <div className="flex items-center space-x-1 text-slate-500">
          ...
          >
            ...
            <option value="cities">도시 많은순</option>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between p-2.5 rounded-xl border text-left transition-all ${
                  isSelected
                    ? "bg-blue-50/70 border-blue-300 ring-1 ring-blue-500/20 text-blue-900"
                ...
                <div className="flex items-center space-x-2.5">
                  <div
                    className={`w-2 h-2 rounded-full ${
                      activeTab === "visited" ? "bg-blue-500" : "bg-emerald-500"
                    }`}
                  />
                  <div>
