            ...
            return (
              <button
                ...
                className={`w-full flex items-center justify-between p-2.5 rounded-xl border text-left transition-all ${
                  isSelected
                    ? "bg-blue-50/90 dark:bg-cyan-950/60 border-blue-500 dark:border-cyan-400 ring-2 ring-blue-500/30 dark:ring-cyan-400/60 shadow-[0_0_15px_rgba(6,182,212,0.35)] text-blue-900 dark:text-cyan-200 font-extrabold scale-[1.01]"
                    : isRegionSelected
                    ? "bg-blue-50/50 dark:bg-cyan-950/30 border-blue-300 dark:border-cyan-500/50 ring-1 ring-blue-400/30 dark:ring-cyan-400/30 text-blue-900 dark:text-cyan-200 font-bold"
